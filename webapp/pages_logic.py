...
def page_innsending():
    ...
    if "submission_success" in st.session_state and st.session_state.submission_success:
        st.success("Bildet er sendt inn og analysert av AI-modellen.")
        st.info("Resultatet finner du under «Foreslåtte avvik» i menyen til venstre.")
...
def page_om_modell():
    ...
    AI-modellen har en treffsikkerhet på rundt 65 %, og er designet som et hjelpemiddel for å øke rapporteringsgraden ved å komme med foreslåtte avvik. 
    """)
...
def page_forside():
    ...
    st.title("Registrering av HMS-avvik med AI")
    ...
    st.subheader("Se hvordan systemet fungerer:")

    col1, col2, col3 = st.columns([1, 1, 1])

    with col2:
        st.video("webapp/Brukerveiledning.mp4")
